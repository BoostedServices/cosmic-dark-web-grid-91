...
const VideoSection = () => {
  ...
  const ShoppingCartIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div className="relative h-[50vh] w-full overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-4">
              ...
              <p className="text-gray-400 text-lg max-w-2xl mx-auto mb-8">See the power of our Fortnite Private software live in action.</p>
              <Button onClick={handleGetItNow} className="bg-gradient-to-r from-[#0036D6] to-[#0028A3] hover:from-[#0036D6]/90 hover:to-[#0028A3]/90 text-white px-8 py-3 text-lg font-semibold rounded-lg flex items-center gap-3 mx-auto">
                <ShoppingCartIcon />
                Get It Now
              </Button>
            </div>
