...
const Product = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-white">
      ...
      <div className="px-4 md:px-8 py-4 border-b" style={{ borderColor: '#111111' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="relative group">
              <Card className="bg-gray-900/50 overflow-hidden" style={{ borderColor: '#111111' }}>
                ...
                {productImages.map((image, index) => (
                  <button
                    ...
                    className={`relative overflow-hidden rounded-lg border-2 transition-all ${
                      currentImageIndex === index ? 'border-[#0036D6]' : 'hover:border-gray-600'
                    }`}
                    style={{ borderColor: currentImageIndex === index ? '#0036D6' : '#111111' }}
                  >
                    <img 
                      src={image} 
            ...
            <div className="space-y-4">
              ...
              {relatedProducts.map((product, index) => (
                <Card key={index} className="bg-gray-900/30 hover:border-[#0036D6]/30 transition-all cursor-pointer" style={{ borderColor: '#111111' }}>
          ...
          <div className="space-y-8">
            {/* Quick Actions */}
            <div className="flex gap-4">
              <Card className="bg-gray-900/30 flex-1" style={{ borderColor: '#111111' }}>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-10 h-10 bg-gray-800 hover:border-[#0036D6] hover:bg-gray-700 rounded-lg transition-all flex items-center justify-center border"
                  ...
                  <Card 
                    ...
                    className={`cursor-pointer transition-all border-2 ${
                      selectedVariant === key 
                        ...
                        : 'bg-gray-900/30 hover:border-gray-600'
                    }`}
                    style={{ borderColor: selectedVariant === key ? '#0036D6' : '#111111' }}
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-900/50 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#0036D6] transition-colors border"
                style={{ borderColor: '#111111' }}
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <Button 
                variant="outline" 
                className="w-full py-4 text-lg transition-all flex items-center justify-center gap-2 bg-white text-black hover:bg-gray-100 font-semibold border-2"
                style={{ borderColor: '#111111' }}
              >
                <CartIcon />
                Add To Cart
            ...
            <div className="flex justify-center">
              <div className="bg-green-500/20 rounded-full px-4 py-2 text-green-400 text-sm font-semibold flex items-center gap-2 border" style={{ borderColor: '#111111' }}>
                <CheckIcon />
                Undetected
              </div>
            </div>
