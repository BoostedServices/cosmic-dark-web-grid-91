    ...
    <div className="min-h-screen bg-[#0A0A0B] relative">
      ...
      <header className="relative z-10 flex items-center justify-between px-8 py-6">
        ...
        <div className="flex items-center">
          <img 
            src="/lovable-uploads/10510cce-014f-4ca1-9e2a-fcf5b2264345.png" 
            alt="Logo" 
      ...
      <main className="relative z-10 flex items-center justify-center min-h-[80vh]">
        <div className="text-center">
          ...
          <p className="text-xl text-[#BEB9B9] max-w-2xl mx-auto leading-relaxed">
            Experience the perfect blend of modern design and functionality
          </p>
        </div>
      </main>
    </div>
