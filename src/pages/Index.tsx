      ...
      <main className="relative z-10 flex items-center min-h-[80vh] px-8">
        <div className="flex items-center justify-between w-full max-w-7xl mx-auto">
          ...
          <div className="flex-1 max-w-2xl">
            ...
            <Button className="bg-[#0036D6] hover:bg-[#0036D6]/90 text-white px-10 text-xl font-semibold rounded-lg flex items-center gap-3 transition-all duration-200 py-[20px]">
              <PurchaseIcon />
              Purchase now
            </Button>
